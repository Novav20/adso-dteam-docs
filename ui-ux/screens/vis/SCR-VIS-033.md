...
| `CMP-05` | Context Container       | Panel contextual de activo       | Superficie: `--dt-color-surface-card`                                                               | Contenedor adaptable (Panel lateral o *Bottom Sheet*). Elevación en Desktop: `--dt-z-overlay-card` (100). Elevación en Móvil: `--dt-z-drawer-sidebar` (800).             |
