...
| **Database Server**       | «Database Node»<br>[Managed DB / Container]          | • PostgreSQL 16 + TimescaleDB Extension                                                                                        | Almacén relacional maestro de activos, inventario, auditoría inmutable de solo inserción (`ADR-003`) y series de tiempo de telemetría. |
