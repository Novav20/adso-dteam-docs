...
\begin{itemize}
    ...
    \item \textbf{Aplicación Móvil:} Interfaz táctil para dispositivos \textbf{Android 11+} con soporte nativo para gestos (pinch-to-zoom) y operación en entornos de baja luminosidad (\textbf{HPHMI Grayscale}).
\end{itemize}
