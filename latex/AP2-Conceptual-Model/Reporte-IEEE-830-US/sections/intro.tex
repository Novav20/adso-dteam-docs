...
El sistema \textbf{``Gemelo Digital de Mantenimiento''} es una plataforma híbrida diseñada para optimizar la gestión operativa y estratégica mediante la convergencia de datos de sensores (IoT), modelos 3D y motores de inferencia IA.
