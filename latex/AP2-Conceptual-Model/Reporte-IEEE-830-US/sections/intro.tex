...
\begin{enumerate}
    ...
    \item \textbf{Inteligencia y Auditoría:} Consola de administración con control de acceso RBAC granular, auditoría inmutable con cadena de integridad criptográfica y dashboards de KPIs (MTBF, MTTR).
    \item \textbf{Framework de Asistencia IA:} Motor de asistencia técnica basado en RAG para consulta de manuales en lenguaje natural.
\end{enumerate}
