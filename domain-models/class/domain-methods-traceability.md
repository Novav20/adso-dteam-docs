...
| `UpdateRimeFactors(risk: Enum, impact: Enum, maintainability: Enum, economy: Enum): void` | Actualiza los 4 factores cualitativos de la matriz RIME.                                                              | [[MTTO-026]]<br>FR-058 a FR-062 | **Consistencia de Agregado:** Los 4 factores determinan el puntaje RIME. Actualizarlos juntos garantiza que el recálculo posterior del `BacklogItem` sea atómico.       |
