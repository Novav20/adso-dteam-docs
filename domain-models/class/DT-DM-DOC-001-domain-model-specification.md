...
| `FunctionalLocation` | `hierarchyLevel`        | `SMALLINT`                 | NOT NULL    | CHECK (1..5)           | Niveles 1 al 5 de la taxonomía ISO 14224 (las Ubicaciones Funcionales gobiernan la estructura espacial de planta hasta el proceso, mientras que L6 a L8 corresponden a equipos y componentes físicos). |
